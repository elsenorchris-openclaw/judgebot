...
PUSH_HIGH_MAX_BET_DEFAULT: float = 5.0  # 2026-06-05 (Chris): 10->5 DE-RISK (6/4 HIGH -$58 MTM, edge unproven live -> halve the swing while settled days accumulate; rollback ->10). Prior 6/3 5->10 (HIGH NO/default). Blend HIGH's first real day decoded ~+$21 with the confident/longshot bets winning (OKC NO 29c->+$12.69); window+timing fixes live. Doubling exposure on the validated +16-18c/ct HIGH edge. Backstop guardrail max_bet_high_series_usd=$20 still caps. LOW stays $1. Rollback ->5.  # (prior: 1->5 6/2; 10->1 START-SMALL 6/2)
