...
PUSH_HIGH_MAX_BET_DEFAULT: float = 1.0  # 2026-06-02 (Chris): 10->1. START-SMALL — uniform $1 max across the WHOLE judge bot to validate today's blend/deep-window/LOW-spread/sigma-exempt changes on live fills before sizing up. min_buy_usd lowered to 0.40 so a $1 cap doesn't collapse at prices >50c (1 contract must clear min-buy). Raise back toward $10 once live P&L confirms. Rollback ->10.  # (prior 2026-05-28: 6->10 after 5/27 +$105 day; cascade: 18-26pp up-tilt min($15,base*2), fat>=26pp de-size base*0.5; BOS/SEA were $15 via PUSH_HIGH_MAX_BET_BY_STATION)
